                    ...
                    <template #content>
                        <div class="left">
                            <div class="grid-12 v-center">
                                ...
                                <?php $this->part('museus/card-edit-subordinacao'); ?>
                            </div>
                        </div>
                ...
                <main>
                    ...
                    <mc-card>
                        <template #title>
                            ...
                            <p><?= i::__('Apresente melhor o seu Espaço.'); ?></p>
                            <p><?= i::__('Adicione documentos, links, vídeos e imagens que contem a sua história.') ?></p>
                        </template>
                        <template #content>
                            <div class="grid-12">
