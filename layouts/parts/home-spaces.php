...
//TODO desduplicar este JSON de mapeamento que clonado do arquivo ng.search.app.js
$space_types = json_decode('[
...
<article id="home-spaces" class="js-page-menu-item home-entity clearfix">
    <div class="box">
        ...
        <ul class="abas clearfix">
            <li class="active"><a href="#space-terms">Tipologia de Acervo</a></li>
