...
<mc-card class="edit-subordinacao">
    <template #title>
        <label><?php i::_e("Informações do museu matriz"); ?></label>
    </template>

    <template #content class="edit-subordinacao__content">
        <small class="col-12 edit-subordinacao__content--description">
        ...
        <div v-if="entity.mus_subordinado_museu_matriz == 'Sim'" class="col-12 edit-subordinacao__content--matriz">
            <entity-field :entity="entity" classes="col-12 sm:col-6" prop="mus_museu_matriz"></entity-field>
    
            <div class="grid-12 edit-subordinacao__content--matriz-fields">
