<nav id="panel-nav" class="sidebar-panel">
    <ul>
        ...
        <?php if(($app->user->is('superAdmin')  || $app->user->is('admin') )): ?>
            ...
            <li><a <?php if($this->template == 'panel/list-users') echo 'class="active"'; ?> href="<?php echo $app->createUrl('panel', 'userManagement') ?>"><span class="icon icon-group"></span> Usuários e papéis</a></li>
