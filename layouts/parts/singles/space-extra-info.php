...
<?php if ( $this->isEditable() || $entity->mus_add_info ): ?>
    ...
    <span
        ...
        data-emptytext="Insira informações adicionais <?php $this->dict('entities: of the space') ?>" ><?php echo $this->isEditable() ? $entity->mus_add_info : nl2br($entity->mus_add_info); ?></span>
<?php endif; ?>