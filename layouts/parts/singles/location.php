...
<?php if ($entity->canUser("viewPrivateData") || (($has_private_location && $entity->publicLocation && $lat && $lng) || (!$has_private_location && $lat && $lng)) ): ?>
    ...
    <div class=" clearfix">
        ...
        <div class="infos">
            ...
            <p><span class="label"><?php \MapasCulturais\i::_e("Região de desenvolvimento:");?></span> <span id="geoRD" data-edit="geoRD" data-original-title="Região de desenvolvimento" data-emptytext="Insira o Município" data-showButtons="bottom"><?php echo $entity->geoRD ?></span></p>
            <p><span class="label"><?php \MapasCulturais\i::_e("Mesorregiao:");?></span> <span id="geoMesorregiao" data-edit="geoMesorregiao" data-original-title="Mesorregiao" data-emptytext="Insira o Município" data-showButtons="bottom"><?php echo $entity->geoMesorregiao ?></span></p>
