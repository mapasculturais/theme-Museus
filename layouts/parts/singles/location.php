...
<?php if ($entity->canUser("viewPrivateData") || (($has_private_location && $entity->publicLocation && $lat && $lng) || (!$has_private_location && $lat && $lng)) ): ?>
    ...
    <div class=" clearfix">
        ...
        <div class="infos">
            ...
            <p><span class="label"><?php \MapasCulturais\i::_e("Macroregião:");?></span> <span class="js-editable" id="EnMacro_regiao" data-edit="EnMacro_regiao" data-original-title="Macro região" data-emptytext="Insira o Município" data-showButtons="bottom"><?php echo $entity->EnMacro_regiao ?></span></p>
