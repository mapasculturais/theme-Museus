...
$logo_image = $app->config['logo.image'];

if ($this->controller->id === 'site' && $this->controller->action === 'index') {
    $logo_image = 'img/logotipoMapasMuseus_branco.png';
}
?>
...
<header class="main-header" id="main-header">
    ...
    <div class="main-header__content">
        ...
        <mc-header-menu>
            ...
            <!-- Logo -->
            <template #logo>
                <a href="<?= $app->createUrl('site', 'index') ?>" class="theme-logo">
                    <div class="theme-logo__logo--img">
                        <img src="<?php $this->asset($logo_image) ?>">
                    </div>
                </a>
            </template>
            <!-- Menu principal -->
